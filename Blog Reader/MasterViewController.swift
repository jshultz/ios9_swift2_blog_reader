...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyD6MJaZ7U02se_GanE5Agl_gC4gf1oe0FI")
...
//                    print(NSString(data: data, encoding: NSUTF8StringEncoding))
                    ...
                    do {
                        ...
                        print("something went wrong with NSJSONSerialization")
                    }
                }
            }
        }
